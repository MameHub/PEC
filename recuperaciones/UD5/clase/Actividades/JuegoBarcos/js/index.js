...
const crearFormulario = () => {
    ...
    etiqueta.setAttribute("for","edad");//Asociamos el label label al input con el id "edad"
...
const crearTablero = (numFilas) =>{
    ...
    for (let f = 0; f < numFilas; f++){
        ...
        for(let c = 0; c < numFilas; c++){
            ...
            columna.setAttribute("id",++contador);//Suma 1 antes de asignar el valor
...
function generarBarcosAleatorios(numFilas){
    ...
    do{
        ...
        //Comprobamos que este número no está ya en el array
...
function pulsar(){
    //Comrpobar si hay barco o hay agua
    ...
    // Comprobamos si ya ha acertado todos
    if(aciertos == 5){
        finalizar();
    }
}
