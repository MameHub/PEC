...
let pintar=false;
/**Espera a que el DOM esté completamente cargado y parseado: El evento "DOMContentLoaded" se dispara cuando el navegador ha terminado de cargar y parsear el HTML, es decir, cuando la estructura del documento está disponible en el DOM. No espera a que se carguen otros recursos externos como imágenes, CSS, etc.
/* DIFERENCIAS.png
Llama a la función establecerEvent(): Una vez que el evento "DOMContentLoaded" se dispara, se ejecuta la función establecerEvent(). */
...
const establecerEvent=()=>{
    ...
    for (const element of elementosInput) {
        ...
        //Podemos dejar marcado enverde el input para ver que e ha pulsado en algún moento el input
        /*element.addEventListener("mouseout",function(){
        ...
        //Cuando suelto el botón del ratón, desaparece la condición
